        ...
        <div className='Home-container'>
          <HomeIcon className="home" onClick={()=>{
            ...
            <div className="login">
                ...
                <div className="mb-3 mt-3">
                    <input style={{'color':'white'}} type="text" placeholder="your matricule?" className="text"  on onChange={(e)=>{
                      console.log(e.target.value)
                      setMatricule(e.target.value)
                    }}/>
                </div>
                <div className="form-group mb-3 mt-3">
                    <input style={{'color':'white'}} type="email" placeholder="your email ?" className="text"  on onChange={(e)=>{
                      console.log(e.target.value)
                      setEmail(e.target.value)
                    }}/>
                </div>
                <div className="mb-3 mt-3">
                    <input style={{'color':'white'}} type="password" placeholder="your password ?" className="text"  on onChange={(e)=>{
                      console.log(e.target.value)
