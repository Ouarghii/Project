    ...
    <div>
        ...
        <HomeIcon className="home"  onClick={()=>{
            ...
            <form action="" method="post">
             ...
             <h2 class="active"><a href="http://localhost:3001/login" >Login </a></h2>
                <h2 class="active" onClick={()=>{
              window.location='/registration'
            }}> <a href="http://localhost:3001/registration" >Registration</a></h2>
                    <input type="text" className="text" placeholder="your username ?"  onChange={(e)=>{
                      console.log(e.target.value)
                      setUsername(e.target.value)
                    }}/>
                </div>
                <div className="mb-3 mt-3">
                    <input type="email" className="text" placeholder="your email ?"onChange={(e)=>{
                      console.log(e.target.value)
                      setEmail(e.target.value)
                    }}/>
                </div>
                <div className="mb-3 mt-3">
                    <input type="password" className="text" placeholder="your password ?"   onChange={(e)=>{
                      console.log(e.target.value)
                ...
                >Register</Button>
                <p style={{ "textDecoration":"underline"}} className="lin"><a  href='http://localhost:3001/login'>Already have an account</a> </p>
                </div>
