  ...
  /* trouver les fournisseurs */
    ...
    return (
        <div className='Home-containe'>
          ...
          }} className='btn '  type='button' onClick={()=>setShow1(!show1)}>Add new Fournisseur</button>
          {show1 &&
                ...
                }} className="btn btn-primary"  type="submit">Add Fournisseur</button>
              </form>
          }
