      ...
      {/* <Header /> */}
        ...
        <HomeIcon className="home"  onClick={()=>{
            ...
            > Registration</h2>
                    ...
                    <input type="text" placeholder="your email ?" className="text" onChange={(e)=>{
                      setEmail(e.target.value)
                    }}/>
                </div>
                
                <div className=" mb-3 mt-3">
                    <input type="text" placeholder="your matricule ?" className="text" onChange={(e)=>{
                      setMatricule(e.target.value)
                    }}/>
                </div>
                <div className=" mb-3 mt-3">
                    <input type="password" placeholder="your password ?" className="text"    onChange={(e)=>{
                ...
                >Login</Button>
                 <p style={{ "textDecoration":"underline"}} className="lin"><a href='http://localhost:3001/registrationa'>you haven't an account ?</a></p>
                </div>
                </div>
